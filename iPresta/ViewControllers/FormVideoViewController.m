...
- (IBAction)addObject:(id)sender
{
    ...
    if (videoTypeSelectedIndex != NoneVideoObjectType) newObject.videoType = @([picker selectedRowInComponent:0]);
