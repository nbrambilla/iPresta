...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _title = [[UILabel alloc] initWithFrame:CGRectMake(53, 0, 80, self.frame.size.height)];
        ...
        _myGivesBadge = [[UILabel alloc] initWithFrame:CGRectMake(185, OFFSET, 20, self.frame.size.height/2)];
        _myGivesBadge.font = [UIFont boldSystemFontOfSize:12.0];
        ...
        _friendsGivesBadge = [[UILabel alloc] initWithFrame:CGRectMake(185, self.frame.size.height/2 - OFFSET, 20, self.frame.size.height/2)];
        _friendsGivesBadge.font = [UIFont boldSystemFontOfSize:12.0];
