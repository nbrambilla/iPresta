...
@property (nonatomic, strong) UIBarButtonItem *cancelPickerViewBarButtonItem;
  ...
  [UIView animateWithDuration:0.3
                   ...
                   animations:^{
                     ...
                     if(completed && hidden){
                       ...
                       if (callBack) callBack([self selectedObject]);
                     }
                   }];
...
//  _pickerViewFont = pickerViewFont;
  ...
  _cancelPickerViewBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(hide)];
  _cancelPickerViewBarButtonItem.tintColor = [UIColor whiteColor];
  ...
  _pickerViewToolBar.items = @[_cancelPickerViewBarButtonItem, flexibleSpace, _pickerViewBarButtonItem];
